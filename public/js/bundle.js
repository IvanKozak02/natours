    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.ok) {
            setTimeout(function () {
              (0, _alerts.showAlert)('success', 'You are successfully logged in!');
              location.assign('/');
            }, 1500);
          }
          _context.next = 12;
        ...
        case 8:
          ...
          (0, _alerts.showAlert)('error', 'You are not logged in. Please, try again.');
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type, endpoint) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', 'Cannot update your data. Please, try again later.');
        case 10:
        case "end":
          return _context.stop();
      }
...
var updatePassword = exports.updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return fetch('http://localhost:3000/api/v1/users/update-my-password', {
            method: 'PATCH',
            body: JSON.stringify({
              password: password,
        ...
        case 7:
          _context2.prev = 7;
          _context2.t0 = _context2["catch"](0);
          (0, _alerts.showAlert)('error', 'Cannot update your password. Try again later.');
        case 10:
        case "end":
          return _context2.stop();
      }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _axios.default)("http://localhost:3000/api/v1/bookings/create-checkout-session/".concat(tourId));
        case 2:
...
var bookToor = document.querySelector('#book-tour');
if (mapEl) {
  var locations = JSON.parse(mapEl.dataset.location);
...
if (bookToor) {
  _stripe.bookTour.addEventListener('click', function (e) {
    (0, _stripe.bookTour)(e.target.dataset.tourId);
  });
}
},{"./login.js":"login.js","./mapbox.js":"mapbox.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
